...
// setting up a new or managing an existing AquaChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your AquaChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new AquaChain network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and aquastats servers |")
	...
	log.Info("Administering AquaChain network", "name", w.network)
