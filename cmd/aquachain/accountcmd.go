...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage AquaChain presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    aquad wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import AquaChain presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	aquad wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    aquad account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    aquad account import [options] <keyfile>
