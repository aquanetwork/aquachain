...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/aquad.ipc",
			endpoint:    "/data/testnet/aquad.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/aquad.ipc",
			endpoint:    "/data/testnet/aquad.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aquad.ipc",
			endpoint:    "/data/testnet/aquad.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/aquad.ipc",
			endpoint:    "/data/testnet/aquad.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
