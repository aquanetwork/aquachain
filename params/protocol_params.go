...
var (
	...
	MinimumDifficultyGenesis = big.NewInt(8192)        // The minimum that the difficulty may ever be
	MinimumDifficultyHF1     = big.NewInt(8192)       // The minimum that the difficulty may ever be (changed to a nice multiple of 2048).
	MinimumDifficultyHF3     = big.NewInt(8192) // The minimum that the difficulty may ever be (changed to a nice multiple of 2048).
