...
var (
	...
	//enesisDifficulty      = big.NewInt(131072) // Difficulty of the Genesis block.
	GenesisDifficulty = big.NewInt(972878) // Difficulty of the Genesis block.
	MinimumDifficulty = big.NewInt(972878) // The minimum that the difficulty may ever be.
	DurationLimit     = big.NewInt(60 * 5) // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
)
