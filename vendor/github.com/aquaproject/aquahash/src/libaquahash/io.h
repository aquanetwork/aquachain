...
enum ethash_io_rc {
	AQUAASH_IO_FAIL = 0,           ///< There has been an IO failure
	AQUAASH_IO_MEMO_SIZE_MISMATCH, ///< DAG with revision/hash match, but file size was wrong.
	AQUAASH_IO_MEMO_MISMATCH,      ///< The DAG file did not exist or there was revision/hash mismatch
	AQUAASH_IO_MEMO_MATCH,         ///< DAG file existed and revision/hash matched. No need to do anything
};
 ...
 * ethash_full_t
 */
#ifdef AQUAASH_PRINT_CRITICAL_OUTPUT
